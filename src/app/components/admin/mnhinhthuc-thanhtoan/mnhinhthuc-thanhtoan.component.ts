...
@Component({
  selector: 'app-mnhinhthuc-thanhtoan',
  templateUrl: './mnhinhthuc-thanhtoan.component.html',
  styleUrls: ['./mnhinhthuc-thanhtoan.component.scss']
})
export class MnhinhthucThanhtoanComponent implements OnInit {
  ...
  AddDanhmuc(){ 
    ...
    this.dongvat.addHinhthucTT({httt_ten:this.addForm.value.tendanhmuc}).subscribe(
      res=>{
  ...
  clickeditDanhmuc(id){
    ...
    this.editForm.setValue({
      tendanhmuc:this.danhmucbyID.httt_ten,
    });
  }
  EditDanhmuc(){
    ...
    this.dongvat.editHinhthucTT(id,{httt_ten:this.editForm.value.tendanhmuc}).subscribe(
      res=>{
        //this.is_confirm=false;
        this.is_success=true;
  ...
  deleteDanhmuc(){
    this.dongvat.deleteHinhthucTT(this.idDelete).subscribe(
      res=>{
        this.is_confirm=false;
        this.is_success=true;
