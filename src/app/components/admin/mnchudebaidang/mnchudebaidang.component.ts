...
@Component({
  selector: 'app-mnchudebaidang',
  templateUrl: './mnchudebaidang.component.html',
  styleUrls: ['./mnchudebaidang.component.scss']
})
export class MnchudebaidangComponent implements OnInit {
  ...
  AddDanhmuc(){ 
    ...
    formData.append('cdbd_ten',this.addForm.value.tendanhmuc);
    this.dongvat.addChude(formData).subscribe(
      res=>{
  ...
  clickeditDanhmuc(id){
    ...
    this.editForm.setValue({
      tendanhmuc:this.danhmucbyID.cdbd_ten,
    });
  }
  EditDanhmuc(){
    ...
    var formData=new FormData();
    formData.append('cdbd_ten',this.editForm.value.tendanhmuc);
    this.dongvat.editChude(id,formData).subscribe(
      res=>{
        //this.is_confirm=false;
        this.is_success=true;
  ...
  deleteDanhmuc(){
    this.dongvat.deleteChude(this.idDelete).subscribe(
      res=>{
        this.is_confirm=false;
        this.is_success=true;
